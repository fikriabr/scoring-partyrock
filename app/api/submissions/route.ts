...
export async function POST(request: NextRequest) {
  try {
    ...
    // Fire-and-forget: kick off scoring without blocking the response. The
    ...
    // Widgets and prompts come from the Capture Pipeline rather than a crawl,
    // so scoring starts immediately on whatever evidence was pasted at
    // submission time.
